...
<html>
	<head>
		...
		<title>Update/Submit Resume</title>
...
<form action = "submitresume.php" method = "post">
	 <div id="logreg-forms">
        <form class="form-signin">
            <h1 class="h3 mb-3 font-weight-normal" style="text-align: center; color: white"> Enter Your Resume Information:</h1>
            ...
            <div class="input-group">
			  ...
			  <br/>
				<label for = "degree" style="color:white">Level of Education: </label>
				<select name = "degree">
				...
				<br/>
				<div class="input-group">
					<input type="text" class="form-control" placeholder="University" name="uni" required="">
				  </div>
				  <br/>
				<label for = "work" style="color:white">Work History:</label> 
				<textarea name = "work" rows = 10 cols = 30></textarea>
				<br>
				<br>
				<br>
				<button class="btn btn-primary btn-block" type="submit" id="btn-signup"><i class="fas fa-user-plus"></i> Upload</button>
		</form>
		</div>
</form>
</body>
